...
split = 'test'
year = '2021'
force_decoding_prob_path = '/opt/tiger/fake_arnold/TransQuest_mello/checkpoints/translation_prob/t5_large_prob_' + split + year + '.txt'
save_prefix = '/opt/tiger/fake_arnold/TransQuest_mello/checkpoints/translation_prob/'
save_label_path = save_prefix + 't5_large_pred_' + split + year + '_threshold' + str(args.threshold) + '.mt_tag'
