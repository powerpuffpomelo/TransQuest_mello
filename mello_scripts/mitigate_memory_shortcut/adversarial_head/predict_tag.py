...
for adv_lambda in [-1.0]:
    model_path_prefix = '/opt/tiger/fake_arnold/TransQuest_mello/train_result_memory_shortcut_adv_en-de_adv_limit_5_lambda_' + str(adv_lambda) + '/'
