...
class RobertaForTLMAndQEOutput(ModelOutput):
    ...
    Args:
        loss (`torch.FloatTensor` of shape `(1,)`, *optional*, returned when `labels` is provided) :
            Classification loss.
        token_translation_logits (`torch.FloatTensor` of shape `(batch_size, sequence_length, config.num_labels)`):
    ...
    token_translation_logits: torch.FloatTensor = None
    token_qe_logits: torch.FloatTensor = None
