...
save_name = '21'
step = '1576'
centers_path = 'checkpoints/train_result_21_proto_finetune_en-de/outputs/centers_' + str(step)
TEST_PATH = "/opt/tiger/fake_arnold/qe_data/qe_data_mello/test21/" + lang_pair + "-test21"
pred_model_name = '21_proto_finetune'
microtransquest_config['best_model_dir'] = "checkpoints/train_result_" + pred_model_name + "_" + lang_pair + "/outputs/checkpoint-" + str(step)
microtransquest_config['centers_path'] = centers_path
...
# python3 /opt/tiger/fake_arnold/TransQuest_mello/mello_scripts/proto/predict_tag_2021.py
