...
PRE_PREFIX=/opt/tiger/fake_arnold/TransQuest_mello/checkpoints/train_result_21_qe_from_tlm6000_lr5e-5_en-de/prediction
python3 mello_scripts/tool/estimate_word.py $GOLD_PREFIX/test19.mt_tag $PRE_PREFIX/test19.mt_tag.pred
